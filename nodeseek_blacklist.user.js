...
(function () {
    ...
    @media (max-width: 767px) {
        ...
        /* 鼠标悬停在标题链接上时整行背景高亮（需 :has 支持，现代浏览器） */
        #favorites-dialog tbody tr:has(td:first-child a:hover) {
            background-color: rgba(24, 144, 255, 0.09) !important;
        }
        #favorites-dialog tbody tr:has(td:first-child a:hover) td {
